...
# Klasa MyFraction nie musi obsługiwać liczb ujemnych - w testach nigdy nie dojdzie do sytuacji gdzie wynik operacji
# matematycznej jest ujemny.

# Pamiętaj jednak że wszystkie dotychczasowej operacje na MyFraction z Zadania 3.1 powinny
# wciąż działać.

# UWAGA: Testy porównujące ze sobą floaty są wykonywane z domyślną dokładnością funkcji assertAlmostEqual
# z frameworku unittest tj z dokładnością do 7mego miejsca po przecinku
...
class MyFraction:
    ...
    @staticmethod
    def _add_numerators(fraction1, fraction2):
        return fraction1.numerator * fraction2.denominator + fraction2.numerator * fraction1.denominator

    @staticmethod
    def _sub_numerators(fraction1, fraction2):
        return fraction1.numerator * fraction2.denominator - fraction2.numerator * fraction1.denominator

    @staticmethod
    def _mul_divisors(fraction1, fraction2):
        return fraction1.denominator * fraction2.denominator

    @staticmethod
    def _mul_numerators(fraction1, fraction2):
