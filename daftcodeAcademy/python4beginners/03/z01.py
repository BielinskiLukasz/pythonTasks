...
class MyFraction():
  ...
  def __iadd__(self, other):
    self.numerator, self.denominator = self.reduction(self.calculate_numerator(self, other), self.calculate_denominator(self, other))
    return self
  ...
  def calculate_numerator(self, fraction1, fraction2):
    return fraction1.numerator * fraction2.denominator + fraction2.numerator * fraction1.denominator
    
  def calculate_denominator(self, fraction1, fraction2):
